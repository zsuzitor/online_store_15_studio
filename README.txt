...
таймер(прелоадер) на ajax запросах поставить меньше?
...
в object_view если слайдер пролистать но на фотку не нажать то мутится чет не то(отображает слуд по списку и слайдер 1 раз веред листает вроде)
}
