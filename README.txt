...
Editorы поменять на целовеческие(инт стринг дата)
...
справа снопка "помощь" или чет такое, кликаешь и выезжает блок с инфой + на него таймер поставить что бы сам выезжал после загрузки страницы + чуть время
