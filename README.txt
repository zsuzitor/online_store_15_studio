...
TODO:
при создании пользователя давать роль user
???при создании бд инициализировать Discount и добавлять (seed)
в списке товаров сделать выбор отображения по страницам или дозагрузкой
personal_record ошибки js пустая страница+скролл
