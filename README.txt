...
при ширине 960 кнопки в main_header за блоки вылезают + слово "выполнить вход" поменять на "вход"
добавление не колчества объекта и редактирование
...
проверить отображаются ли в списке объекты(количество 0) 
